...
/**
 * Created by wonjun-pc on 2016-07-04.
 */
...
public class URLShortener {
    ...
    public static final String API_KEY = "AIzaSyBthERGHP49DNjql7F69AQtGZUVb1MheH8"; // 새로운 키 등록 필요
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[DEBUG] main() RESULT_URL  : " + URLShortener.getShortenUrl(originalUrl));
    }
}