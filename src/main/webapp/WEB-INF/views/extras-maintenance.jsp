...
<html>
    ...
    <body>
        ...
        <div class="progress progress-bar-custom-alt progress-sm m-b-0">
            <div class="progress-bar progress-bar-custom progress-bar-striped active" role="progressbar" aria-valuenow="91" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class="home-wrapper">
                            ...
                            <h1 class="home-text text-uppercase text-custom">신용송부인증이 완료되었습니다.</h1>
