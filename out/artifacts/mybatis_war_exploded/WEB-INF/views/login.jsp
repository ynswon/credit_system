...
<head>
    ...
    <link href=<c:url value="/resources/assets/css/core.css"/> rel="stylesheet" type="text/css" />
    <link href=<c:url value="/resources/assets/css/components.css"/> rel="stylesheet" type="text/css" />
    <link href=<c:url value="/resources/assets/css/icons.css"/> rel="stylesheet" type="text/css" />
    <link href=<c:url value="/resources/assets/css/pages.css"/> rel="stylesheet" type="text/css" />
    <link href=<c:url value="/resources/assets/css/menu.css"/> rel="stylesheet" type="text/css" />
...
<div class="wrapper-page">
    <div class="text-center">
        <a href="index.html" class="logo"><span>Funda<span>Admin</span></span></a>
        <h5 class="text-muted m-t-0 font-600">Funda Admin</h5>
    </div>
    <div class="m-t-40 card-box">
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" action="/loginProcess" method="POST" >
