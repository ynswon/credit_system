                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                        		<div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">총 대출자수</h4>

                                    <div class="widget-chart-1">
                                        <div class="widget-chart-box-1">
                                            <input data-plugin="knob" data-width="80" data-height="80" data-fgColor="#f05050 "
                                               data-bgColor="#F9B9B9" value="${total_debt}"
                                               data-skin="tron" data-angleOffset="180" data-readOnly=true
                                               data-thickness=".15"/>
                                        </div>

                                        <div class="widget-detail-1">
                                            <h2 class="p-t-10 m-b-0"> ${today_debt} </h2>
                                            <p class="text-muted">오늘 대출자수</p>
                                        </div>
                                    </div>
                        		</div>
                            </div><!-- end col -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="/resources/assets/images/users/avatar-3.jpg" class="img-responsive img-circle" alt="user">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="/resources/assets/images/users/avatar-2.jpg" class="img-responsive img-circle" alt="user">
                                        <div class="wid-u-info">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="/resources/assets/images/users/avatar-1.jpg" class="img-responsive img-circle" alt="user">
                                        <div class="wid-u-info">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="/resources/assets/images/users/avatar-10.jpg" class="img-responsive img-circle" alt="user">
                                        <div class="wid-u-info">
									...
									<div class="inbox-widget nicescroll" style="height: 315px;">
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/assets/images/users/avatar-1.jpg" class="img-circle" alt=""></div>
                                                <p class="inbox-item-author">Chadengle</p>
                                                <p class="inbox-item-text">Hey! there I'm available/resources.</p>
                                                <p class="inbox-item-date">13:40 PM</p>
                                            </div>
                                        </a>
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/assets/images/users/avatar-2.jpg" class="img-circle" alt=""></div>
                                                <p class="inbox-item-author">Tomaslau</p>
                                                <p class="inbox-item-text">I've finished it! See you so/resources.</p>
                                                <p class="inbox-item-date">13:34 PM</p>
                                            </div>
                                        </a>
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/assets/images/users/avatar-3.jpg" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/assets/images/users/avatar-4.jpg" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/assets/images/users/avatar-5.jpg" class="img-circle" alt=""></div>
